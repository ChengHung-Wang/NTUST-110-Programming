...
public:
	...
	// Setting constructor
	Hero(int x, int y, int level = 1, int maxExp = 10, int currentExp = 0, int health = 20, char icon = 'H') {
		this->sPos.x = x;
		this->sPos.y = y;
		this->sLevel = level;
	...
	// Setting constructor
	Hero(Position& pos, int level = 1, int maxExp = 10, int currentExp = 0, int health = 20, char icon = 'H') {
		this->sPos = pos;
		this->sLevel = level;
		this->sCurrentExp = currentExp;
		this->sMaxExp = maxExp;
