...
int main(int argc, char** argv)
{
	...
	gHero.setPos(getRandomEmptySpace());
	gCreature.setPos(getRandomEmptySpace());

	Position t1Pos = getRandomEmptySpace();
	Trigger t1(t1Pos, rand() % 10 + 1);
	gTriggers.push_back(&t1);

	Position t2Pos = getRandomEmptySpace();
	Trigger t2(t2Pos, rand() % 10 + 1);
	gTriggers.push_back(&t2);
