...
final class BcMathNumber
{
     ...
     * @return BcMathNumber
     */
    public function pow($num, int $scale = null)
    {
     ...
     * @return BcMathNumber
     */
    public function powmod($num, $mod, int $scale = null)
    {
     ...
     * @return int
     */
    public function compare($num, int $scale = null)
    {
     ...
     * @return boolean
     */
    public function isEquals($num, int $scale = null)
    {
     ...
     * @return boolean
     */
    public function isGreaterThan($num, int $scale = null)
    {
     ...
     * @return boolean
     */
    public function isLessThan($num, int $scale = null)
    {
        return $this->compare($num, $scale) == -1;
    }
     ...
     * @return boolean
     */
    public function isGreaterOrEquals($num, int $scale = null)
    {
        return $this->compare($num, $scale) >= 0;
    }
     ...
     * @return boolean
     */
    public function isLessOrEquals($num, int $scale = null)
    {
        return $this->compare($num, $scale) <= 0;
    }
